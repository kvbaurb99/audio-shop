...
export default function About() {
  return (
    <div className='md:w-[60%] w-[80%] flex mx-auto mt-[10%] md:h-[550px] relative justify-between flex-col md:flex-row'>
        <div>
            <img src={Photo} className='rounded-lg h-[400px] md:h-[550px] object-cover w-full md:w-auto md:hidden' />
        </div>
        ...
        <div>
            <img src={Photo} className='rounded-lg h-[400px] md:h-[550px] object-cover w-full md:w-auto md:block hidden' />
        </div>
    </div>
  )
}
