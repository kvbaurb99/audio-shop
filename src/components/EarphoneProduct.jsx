...
export default function EarphoneProduct({name, description, image, category}) {
  return (
    <div className='w-full h-[560px] flex items-center justify-around'>
      <div className='w-[30%]'>
        ...
        <Link to={`/${category}/${name}`}><button className='bg-[#D87D4A] text-xs px-10 py-2 text-white mt-4 hover:bg-[#FBAF85]'>SEE NOW</button></Link>
      </div>
      <div className='w-[50%]'>
