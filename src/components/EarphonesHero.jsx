...
export default function EarphonesHero({cart, setCart, username, usernameReg, passwordReg, password, setUsername, setPassword, setUsernameReg, setPasswordReg, authData}) {
  ...
  return (
    ...
    <div className='w-full h-[240px] flex justify-center items-center'>
        <p className='text-white font-bold text-3xl tracking-widest text'>EARPHONES</p>
    </div>
    </div>
  )
}
