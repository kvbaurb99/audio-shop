  ...
  return (
    <div className='w-[80%] mx-auto flex h-[600px] items-center relative'>
        <div className='max-w-[440px] text-white relative product'>
            ...
            <Link to='/headphones/xx99-mark-two-headphones'><button className='bg-[#D87D4A] mt-4 px-12 py-3 text-sm hover:bg-[#FBAF85]'>SEE PRODUCT</button></Link>
        </div>
        <div className='absolute right-[10%] opacity-80 image'>
            <img src="https://d287ku8w5owj51.cloudfront.net/images/products/hero/creative-outlier-black/pdt-mhl-creative-outlier-black-mobile.png?width=750" className='w-[400px]' />
        </div>    
    </div>
  )
}
